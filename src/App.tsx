      ...
      <main className=' flex-1 p-6 flex gap-6'>
        ...
        <aside className='w-80 space-y-6'>
          <form className="space-y-6">
            <label
              htmlFor="video"
              className='flex flex-col rounded-md aspect-video cursor-pointer border border-dashed text-sm gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5 transition-colors'
            >
          ...
          <form className='space-y-6'>
            <div className='space-y-2'>
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value='1'>Título do Youtube</SelectItem>
                  <SelectItem value='2'>Descrição da Youtube</SelectItem>
                </SelectContent>
              </Select>
            </div>
